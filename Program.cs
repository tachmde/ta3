...
namespace LinkedList
{
    ...
    new Student("Владислав", "Шевченко", 7, " ", " ")
            ...
            {
                Console.WriteLine($"Студент {student.Name} {student.Surname}, номер у списку: {student.StudentId}");
            }

            Console.WriteLine("Оберіть тип завдань для перевірки:\n1. Теоретичнi завдання\n2. Практичнi завдання");
            ...
            {
                Console.WriteLine($"Студент {student.Name} {student.Surname}, номер у списку: {student.StudentId}," +
                                  $"теоретичнi запитання: {student.TheoryExamResult}, практика: {student.PracticalTasksResult}");
            }
        }
        ...
        static void TheoryExamResult(LinkedList<Student> exam)
        {
            ...
            foreach (var student in exam)
            {
                ...
                Console.WriteLine($"Студент {student.Name} {student.Surname}, " +
                                  $"номер у списку: {student.StudentId}, теоретичнi запитання: {student.TheoryExamResult}");
                Console.ReadKey();
                Console.Clear();
            }
        }
        ...
        static void PracticalTasksResult(LinkedList<Student> exam)
        {
            ...
            foreach (var student in exam)
            {
                ...
                Console.WriteLine($"Студент {student.Name} {student.Surname}, " +
                                  $"номер у списку: {student.StudentId}, практика: {student.PracticalTasksResult}");
                Console.ReadKey();
                Console.Clear();
            }
        }
